...
// Notification System
$stmt = $pdo->prepare("SELECT COUNT(*) FROM documents WHERE department = 'DATA_SCIENCE' AND is_read = 0");
$stmt->execute();
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['upload'])) {
    $title = $_POST['title'];
    $department = $_POST['department'] ?? 'DATA_SCIENCE'; // Default to IT if not selected
    ...
    if ($fileSize > $maxSize) {
        ...
        header("Location: DATA_SCIENCE.php?upload=success");
        exit();
    } else {
...
$stmt = $pdo->prepare("SELECT * FROM documents WHERE department = 'DATA_SCIENCE'");
...
<head>
    <meta charset="UTF-8">
    <title>DATA_SCIENCE Department</title>
...
<body>
    <header>
        <h1>DATA_SCIENCE Department Portal</h1>
    ...
    <form method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <select id="department" name="department">
                <option value="DATA_SCIENCE" selected>DATA_SCIENCE Department</option>
    ...
    <!-- 3. View Section -->
    <section>
        <h2>DATA_SCIENCE Department Documents</h2>
                ...
                <tr>
                    ...
                    <td>
                        <?php if (isset($_GET['edit']) && $_GET['edit'] == $doc['id']): ?>
                            ...
                            <a href="DATA_SCIENCE.php">Cancel</a>
                            </form>
                        <?php else: ?>
                            <a href="DATA_SCIENCE.php?edit=<?= $doc['id'] ?>">Edit</a>
                        <?php endif; ?>
                    </td>
                </tr>
                <?php endforeach; ?>
