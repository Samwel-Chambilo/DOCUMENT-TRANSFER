...
// Notification System
$stmt = $pdo->prepare("SELECT COUNT(*) FROM documents WHERE department = 'TELECOMMUNICATION' AND is_read = 0");
$stmt->execute();
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['upload'])) {
    $title = $_POST['title'];
    $department = $_POST['department'] ?? 'TELECOMMUNICATION'; // Default to IT if not selected
    ...
    if ($fileSize > $maxSize) {
        ...
        header("Location: TELECOMMUNICATION.php?upload=success");
        exit();
    } else {
...
<head>
    <meta charset="UTF-8">
    <title>TELECOMMUNICATION Department</title>
...
<body>
    <header>
        <h1>TELECOMMUNICATION Department Portal</h1>
    ...
    <form method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <select id="department" name="department">
                <option value="TELECOMMUNICATION" selected>TELECOMMUNICATION Department</option>
    ...
    <!-- 3. View Section -->
    <section>
        <h2>TELECOMMUNICATION Department Documents</h2>
                ...
                <tr>
                    ...
                    <td>
                        <?php if (isset($_GET['edit']) && $_GET['edit'] == $doc['id']): ?>
                            ...
                            <a href="TELECOMMUNICATION.php">Cancel</a>
                            </form>
                        <?php else: ?>
                            <a href="TELECOMMUNICATION.php?edit=<?= $doc['id'] ?>">Edit</a>
                        <?php endif; ?>
                    </td>
                </tr>
                <?php endforeach; ?>
